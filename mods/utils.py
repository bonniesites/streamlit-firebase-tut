...
def search_str(file_path, search_term, choice):
    ...
    with open(file_name, 'w') as f_out:
        ...
        for line in term_found_list:
            # Highlight the search term in the line using Markdown formatting
            highlighted_line = line.replace(search_term, f'<span style="color: hotpink;"><u>**{search_term}**</u></span>')
            # Display the line with Markdown formatting
            # st.sidebar.warning('search term highlight invoked')
            highlighted_list.append(highlighted_line)  
    ...
    return file_name, count, highlighted_list

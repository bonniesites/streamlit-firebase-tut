...
if 'sort_order' not in st.session_state:
    st.session_state.sort_order = pymongo.DESCENDING
...
def main():
    ...
    # with search:       
        ...
        if submitted:
            ...
            st.rerun()
    # with filter:
        # label, box = st.columns([2, 4])
        # with label:
        #'Filter by: '
        # with box:
        filter_choice = st.selectbox("Filter by:", ['All', 'Done', 'Pending'])
    ...
    filter_query = query_coll(filter_choice, search_term)
